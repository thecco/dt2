...
export function HighlightMaterial({ mesh, baseColor = new THREE.Color(0xc0a2f5), xMin, xMax, yMin, yMax, softness } = {}) {
	...
	material.onBeforeCompile = (shader) => {
		...
		shader.uniforms.highlightBaseAlpha = { value: 0.4 };
...
uniform float highlightBaseAlpha;
